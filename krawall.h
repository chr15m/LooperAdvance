...
The flag KRAM_QM_RAMP (must be OR'd) enables stop-ramping. Especially looped samples
that get stopped abruptly might cause pops. This will remove them at the cost
of a little more CPU-usage.
*/
